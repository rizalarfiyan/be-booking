...
namespace Booking\Response;

use Booking\Exception\InvalidArgumentException;
use Booking\Trait\MessageTrait;
...
class Response implements ResponseInterface
{
    ...
    /**
     * @param string|StreamInterface $body Stream identifier and/or actual stream resource
     ...
     */
    private function setStatusCode($code, string $reasonPhrase = '') : void
    {
        if (! is_numeric($code)
            || is_float($code)
