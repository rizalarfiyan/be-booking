...
$router->group('/api/v1/', function ($router) {
    ...
    $router->group('/book', function ($router) use ($auth, $admin) {
        ...
        $router->get('/{id}/recommendation', App\Controllers\Book\RecommendationBookController::class);
        $router->get('/{id}/stock', App\Controllers\Book\StockBookController::class);
